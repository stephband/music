// music.harmony.js
// Analysises arrays of intervals for harmonic properties.
//
// Reference:
...
(function() {
	var fn = require('../../functions/js/functions.js'),
	    average = fn.average,
	    gcd = fn.gcd,
	    fnAdd = fn.fnAdd,
	...
	var intervals = justIntervals(),
	    ...
	    // maths. Essentially a common numerator. Just stack all the primes.
	    factor = 37 * 31 * 29 * 23 * 19 * 17 * 13 * 11 * 7 * 5 * 4 * 3 * 2,

	    factorvals = intervals.map(function(n) {
	    	return n * factor;
	    });
	...
	function byConsonance(a, b) {
		var consonance = b.consonance - a.consonance;
		...
		var density = a[a.length - 1] - b[b.length - 1];
